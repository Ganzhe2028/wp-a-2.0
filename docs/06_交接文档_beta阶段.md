...
> ⚠️ **历史文档（已过期）**：本文是 v2.0 账号系统完成后的交接快照（2026-06）。其后的 2026-07-30 活动流改版（DAY 1 / DAY 3、互解锁、admin 重写）与 2026-07-31 WP26 对齐（六开关、`/loc` 与收藏下线）均未记录在本文中。当前事实以 `README.md`、`docs/03_操作手册.md`、`docs/08_UI差距分析_WP26设计稿对齐.md` 和 `AGENTS.md` 为准。
